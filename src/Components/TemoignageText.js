    ...
    const contenu = props.abouts.map((ComposantTemoignage) =>
        <div key={ComposantTemoignage.id}>
            <Typography sx={{
                ...
                <Box component='img' src={CheckMark} sx={{ marginRight: "10px" }} />{ComposantTemoignage.title}<Typography sx={{ marginLeft: '38px', fontFamily: 'Orelega One' }}>{ComposantTemoignage.content}</Typography></Typography>
